                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            @foreach($articles as $article)
                                                <td>
                                                    <a href="{{route('admin.article.edit', [$article->id])}}">{{$article->titre}}</a>
                                                </td>
                                                <td>
                                                    <a href="{{route('admin.article.edit', [$article->id])}}">{{$article->article_categorie_id}}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <form action="{{route('admin.publish.update', [$article->id])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        {{method_field('PUT')}}
